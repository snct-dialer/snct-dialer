...
# Wallboard3.php
#
# Copyright (C) 2017  Jörg Fring-Fürst <jff@flyingpenguin.de>    LICENSE: AGPLv3
#               2017  flyingpenguin.de UG <info@fylingpenguin.de>
#
# live real-time Wallboard
#
# CHANGELOG:
...
if (!isset($CUSTPHONEdisplay)) 
	{
	if (!isset($RS_CUSTPHONEdisplay)) {$CUSTPHONEdisplay=1;}
...
$select_list .= "<a href='#' onclick=\\\"hideDiv(' ');\\\">"._QXZ("Close Panel")."</a><BR><BR>";
...
var AnzeigeAll = '<?php echo $AnzeigeAll ?>';
